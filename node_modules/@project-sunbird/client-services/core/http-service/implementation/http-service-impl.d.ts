...
export declare class HttpServiceImpl implements CsHttpService {
    ...
    readonly bearerTokenInjectRequestInterceptor: BearerTokenInjectRequestInterceptor;
    private _userTokenInjectRequestInterceptor?;
    readonly userTokenInjectRequestInterceptor: UserTokenInjectRequestInterceptor;
